	...
	<form action="BoardUpdateProc.jsp" method="post">
			<table width="600" border="1" bordercolor="gray" bgcolor="skyblue">
				...
				<tr height="40">
					...
					<td width="480" colspan="3">&nbps;<input type="text" name="subject" value="<%=bean.getSubject() %>" size="60"></td>	
				</tr>
				<tr height="40">
					<td align="center" width="120">비밀번호</td>
					<td width="480" colspan="3">&nbps;<input type="password" name="password" size="60"></td>	
				</tr>
				<tr height="40">
				...
				<tr height="40">
					<td colspan="4" align="center">
						...
						<input type="submit" value="글수정">&nbsp;&nbsp;<input type="button" onclick="location.href='BoardList.jsp'" value="전체 글 보기">
					</td>
				</tr>
			</table>
		</form>
